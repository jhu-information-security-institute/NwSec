# Script to clone specific files for creating an Ubuntu environment within a Docker container
# running a minimal Ubuntu image
...
echo 'applications/client/UbuntuX86-64/.project' >> .git/info/sparse-checkout
